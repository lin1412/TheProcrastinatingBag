...
:: Android packaging
set AND_CERT_NAME="TheProcrastinatingBag"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TheProcrastinatingBag.p12
...
set IOS_PROVISION=cert\TheProcrastinatingBag.mobileprovision
...
set APP_ID=air.TheProcrastinatingBag

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TheProcrastinatingBag
